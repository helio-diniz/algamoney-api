...
public class Mailer {
	 ...
	 * this.enviarEmail("helio.diniz74@gmail.com",
	 * Arrays.asList("heliodinizstore@gmail.com"), "Testando",
	 * "Olá!<br/>Teste OK!");
	 ...
	 * 
	 * this.enviarEmail("helio.diniz74@gmail.com",
	 * Arrays.asList("heliodinizstore@gmail.com"), "Testando", template,
	 * variaveis); System.out.println("Terminado o envio de e-mail ..."); }
	 */
	public void avisarSobreLancamentoVencidos(List<Lancamento> vencidos, List<Usuario> destinatarios){
		Map<String, Object> variaveis = new HashMap<>();
		...
		this.enviarEmail("helio.diniz74@gmail.com", emails, "Lançamentos Vencidos", 
	...
	public void enviarEmail(String remetente, List<String> destinatarios, String assunto, String mensagem) {
		try {
			...
			mailSender.send(mimeMessage); // envio de fato do e-mail
