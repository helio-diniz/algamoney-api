...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		// Criteria do JPA
		CriteriaBuilder builder = manager.getCriteriaBuilder(); // cria
																// construtor de
																// Criteria
		CriteriaQuery<Lancamento> criteria = builder.createQuery(Lancamento.class); // criacação
																					// da
																					// criteria
																					// para
																					// Query
		// adicionar as restricões
	...
	private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		if (!StringUtils.isEmpty(lancamentoFilter.getDescricao())) {
			// where descricao like '%adfdafdsaf%
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		query.setFirstResult(primeiroRegistroDaPagina); // a página começa no registro primeiroRegistroDaPagina
		query.setMaxResults(totalRegistrosPorPagina); // a página terá totalRegistrosPorPagina
	}
	...
	public List<LancamentoEstatisticaPessoa> porPessoa(LocalDate dataInicio, LocalDate dataFim) {
		...
		criteria.orderBy(builder.asc(root.get(Lancamento_.pessoa.getName())));
