...
public class S3 {
	...
	public String salvarTemporariamente(MultipartFile arquivo) {
		// 1) qual a permissão deixada para o objeto
		// 2) alguns metadados
		...
		String nomeUnico = geraNomeUnico(arquivo.getOriginalFilename());
	...
	private String geraNomeUnico(String nomeOrignalArquivo) {
		return UUID.randomUUID().toString() + "_" + nomeOrignalArquivo;
	}
