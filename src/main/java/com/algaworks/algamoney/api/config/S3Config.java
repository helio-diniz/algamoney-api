	...
	public AmazonS3 amazonS3(){
		...
		if (!amazonS3.doesBucketExistV2(property.getS3().getBucket())){
			...
			BucketLifecycleConfiguration.Rule regraExpiracao = 
					...
					.withFilter(new LifecycleFilter(new LifecycleTagPredicate(new Tag("expirar", "true")))) // aplica a regra para arquivos com tag expirar
					.withExpirationInDays(1) // configura a expiração em 1 dia
