...
import com.algaworks.algamoney.api.exceptionhanlder.AlgamoneyExceptionHandler.Erro;
...
/*
		OutputStream out = new FileOutputStream("/Users/helio/Documents/anexo--" + anexo.getOriginalFilename());
...
*/		String nome = s3.salvarTemporariamente(anexo);		
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo){
		...
		return lancamentoBuscado.isPresent()?ResponseEntity.ok(lancamentoBuscado.get()): ResponseEntity.notFound().build() ;
	}
